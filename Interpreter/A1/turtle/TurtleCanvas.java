...
public class TurtleCanvas extends Canvas {
    final static int UNIT_LENGTH = 30;    // ìÆÇ≠Ç∆Ç´ÇÃíPà í∑Ç≥
    final static int DIRECTION_UP = 0;    // è„å¸Ç´
    final static int DIRECTION_RIGHT = 3; // âEå¸Ç´
    final static int DIRECTION_DOWN = 6;  // â∫å¸Ç´
    final static int DIRECTION_LEFT = 9;  // ç∂å¸Ç´
    final static int RELATIVE_DIRECTION_RIGHT = 3; // âEÇ…å¸Ç≠
    final static int RELATIVE_DIRECTION_LEFT = -3; // ç∂Ç…å¸Ç≠
    final static int RADIUS = 3; // îºåa
